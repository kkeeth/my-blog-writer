...
- note マガジン「ズレたままでいる」（無料のエッセイ連載）：合理では説明できないこだわりの記録。週1本目標，火曜または水曜に公開。判定軸も書式も他の4チャネルと異なる。
...
- **ネタ出しと採否判定**は Cowork のスケジュールタスク（毎週日曜）で行う。このリポジトリでは扱わない。
...
.claude/
  skills/note-writing/
    ...
    references/
      ...
      zure-sample.md             ← 「ズレたままでいる」文体見本（formatterのみ読む）
  agents/
